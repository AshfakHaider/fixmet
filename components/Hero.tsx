...
import { Zap, Briefcase, ChevronDown } from 'lucide-react'

const words = ['Emergency', 'Home', 'Repairs,', 'Sorted', 'in', 'Minutes.']
const pills = ['Electrician', 'Plumber', 'Locksmith', 'Gas & Boiler', 'Handyman']
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Fixmate connects UK homeowners with verified, insured tradespeople — on
          demand, day or night. Electricians, plumbers, locksmiths, gas engineers
          and handymen, dispatched to your door.
        </motion.p>
