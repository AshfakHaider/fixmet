      ...
      >
        ...
        >
          {[
            {
              Icon: Mail,
              label: 'EMAIL',
              value: <a href="mailto:info@fixmet.co.uk" style={{ color: 'var(--text-primary)', textDecoration: 'none' }}>info@fixmet.co.uk</a>,
            },
            {
              Icon: MapPin,
              label: 'ADDRESS',
            ...
            },
            {
              ...
              label: 'COMPANY',
              value: (
                <span>Fixmet Solutions Ltd<br />Company No. 17008216</span>
              ),
            },
            ...
            >
              <div style={{
                ...
                <Icon size={20} style={{ color: 'var(--accent-blue-bright)' }} />
              </div>
              <div>
                <p style={{
                  fontFamily: 'var(--font-geist)',
          ...
          <p style={{
            ...
            Fixmet Solutions Ltd is registered in England &amp; Wales (Company No.&nbsp;17008216).
            Registered office: 49 Gelligaer Street, Cardiff, Wales, CF24 4LD.
          </p>
        </motion.div>
      </div>
    </section>
